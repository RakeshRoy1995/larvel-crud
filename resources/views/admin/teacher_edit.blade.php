    ...
    <section id="main-content">
     ...
     <div id="login-page">
      <div class="container">
        ...
        <form class="form-login" action="{{ url('/update_teachers/'.$all_teachers_info->id) }}" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="login-wrap">
            ...
            <button class="btn btn-theme btn-block"  type="submit"><i class="fa fa-lock"></i> Update Teacher</button><hr>
          </div>
        </form>
