	    ...
	    <div class="container">
	      ...
	      <form class="form-login" action="{{ url('/save_teachers') }}" method="post" enctype="multipart/form-data">
	        ...
	        <div class="login-wrap">
	          <input type="text" name="name" class="form-control" placeholder="Teacher's Name" autofocus>
	          <br>
	          ...
	          <br>
	          <input type="text" name="email" class="form-control" placeholder="Teacher's Email" autofocus>
	          <br>
	          <input type="text" name="number" class="form-control" placeholder="Teacher's Mobile No" autofocus>
	          <br>
